...
function ContactMe () {
    ...
    return(
        <div className='routeContent'>
            <h2 className='headLine'> Contact Me </h2>
            <p> jayson.ambrose.87@gmail.com </p>
            ...
            <a href='https://docs.google.com/document/d/1wHQA8-FSYJeYRZdkNHxo8PkzYWSqU9dW5HXyutUYVvQ/edit?usp=sharing' rel="noreferrer" target='_blank'> Resume </a>
